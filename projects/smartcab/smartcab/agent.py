        ...
        if self.learning:
            if state not in self.Q:
                ...
                for item in self.valid_actions:
                    newdictionary[item] = 0.0
                self.Q[state] = newdictionary
    ...
    def choose_action(self, state):
        ...
        if self.learning:
            ...
            if random_value < self.epsilon:
                ...
                highestQ_actions = [i for i, value in self.Q[state].items() if value == self.get_maxQ(state)]
                action = random.choice(highestQ_actions)
